...
)
{
        ...
        idbuffer->id_code = 0;
        idbuffer->dictionary_owner_soft = _strdup ("");
        idbuffer->object_owner_soft = _strdup ("");
        idbuffer->dictionary_owner_hard = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("IDBUFFER");
        DxfIdbufferEntityPointer * entity_pointer = NULL;
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (idbuffer->dictionary_owner_soft));
}
...
)
{
        ...
        idbuffer->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (idbuffer);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (idbuffer->object_owner_soft));
}
...
)
{
        ...
        idbuffer->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (idbuffer);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (idbuffer->dictionary_owner_hard));
}
...
)
{
        ...
        idbuffer->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (idbuffer);
...
)
{
        ...
        entity_pointer->soft_pointer = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (entity_pointer->soft_pointer));
}
...
)
{
        ...
        entity_pointer->soft_pointer = _strdup (soft_pointer);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (entity_pointer);
