...
)
{
        ...
        light->id_code = 0;
        light->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        light->layer = _strdup (DXF_DEFAULT_LAYER);
        light->thickness = 0.0;
        ...
        light->shadow_mode = 0;
        light->dictionary_owner_hard = _strdup ("");
        light->material = _strdup ("");
        light->dictionary_owner_soft = _strdup ("");
        light->lineweight = 0;
        light->plot_style_name = _strdup ("");
        light->color_value = 0;
        light->color_name = _strdup ("");
        light->transparency = 0;
        light->light_name = _strdup ("");
        light->intensity = 0.0;
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("LIGHT");
...
)
{
        ...
        light->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (light);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (light->dictionary_owner_soft));
}
...
)
{
        ...
        light->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (light);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (light->object_owner_soft));
}
...
)
{
        ...
        light->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (light);
...
)
{
        ...
        light->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (light);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (light->dictionary_owner_hard));
}
...
)
{
        ...
        light->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (light);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (light->plot_style_name));
}
...
)
{
        ...
        light->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (light);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (light->color_name));
}
...
)
{
        ...
        light->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (light);
