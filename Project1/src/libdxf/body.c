...
)
{
        ...
        body->id_code = 0;
        body->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        body->layer = _strdup (DXF_DEFAULT_LAYER);
        body->elevation = 0.0;
        body->thickness = 0.0;
        ...
        body->shadow_mode = 0;
        body->dictionary_owner_soft = _strdup ("");
        body->object_owner_soft = _strdup ("");
        body->material = _strdup ("");
        body->dictionary_owner_hard = _strdup ("");
        body->plot_style_name = _strdup ("");
        body->color_value = 0;
        body->color_name = _strdup ("");
        body->transparency = 0;
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("BODY");
...
)
{
        ...
        body->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (body);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (body->dictionary_owner_soft));
}
...
)
{
        ...
        body->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (body);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (body->object_owner_soft));
}
...
)
{
        ...
        body->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (body);
...
)
{
        ...
        body->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (body);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (body->dictionary_owner_hard));
}
...
)
{
        ...
        body->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (body);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (body->plot_style_name));
}
...
)
{
        ...
        body->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (body);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (body->color_name));
}
...
)
{
        ...
        body->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (body);
