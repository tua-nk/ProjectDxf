...
)
{
        ...
        attrib->id_code = 0;
        attrib->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        attrib->text_style = _strdup (DXF_DEFAULT_TEXTSTYLE);
        attrib->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        attrib->dictionary_owner_soft = _strdup("");
        attrib->object_owner_soft = _strdup("");
        attrib->material = _strdup("");
        attrib->dictionary_owner_hard = _strdup("");
        attrib->lineweight = 0;
        attrib->plot_style_name = _strdup ("");
        attrib->color_value = 0;
        attrib->color_name = _strdup ("");
        attrib->transparency = 0;
        attrib->default_value = _strdup ("");
        attrib->tag_value = _strdup ("");
        attrib->height = 0.0;
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("ATTRIB");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attrib->linetype));
}
...
)
{
        ...
        attrib->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attrib);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attrib->dictionary_owner_soft));
}
...
)
{
        ...
        attrib->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attrib);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attrib->object_owner_soft));
}
...
)
{
        ...
        attrib->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attrib);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attrib->material));
}
...
)
{
        ...
        attrib->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attrib);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attrib->dictionary_owner_hard));
}
...
)
{
        ...
        attrib->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attrib);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attrib->plot_style_name));
}
...
)
{
        ...
        attrib->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attrib);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attrib->color_name));
}
...
)
{
        ...
        attrib->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attrib);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attrib->default_value));
}
...
)
{
        ...
        attrib->default_value = _strdup (default_value);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attrib);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attrib->tag_value));
}
...
)
{
        ...
        attrib->tag_value = _strdup (tag_value);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attrib);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attrib->text_style));
}
...
)
{
        ...
        attrib->text_style = _strdup (text_style);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attrib);
