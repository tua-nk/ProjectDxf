...
)
{
        ...
        sun->id_code = 0;
        sun->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        sun->layer = _strdup (DXF_DEFAULT_LAYER);
        sun->elevation = 0.0;
        sun->thickness = 0.0;
        ...
        sun->dictionary_owner_soft = _strdup ("");
        sun->object_owner_soft = _strdup ("");
        sun->material = _strdup ("");
        sun->dictionary_owner_hard = _strdup ("");
        sun->lineweight = 0;
        sun->plot_style_name = _strdup ("");
        sun->color_value = 0;
        sun->color_name = _strdup ("");
        sun->transparency = 0;
        sun->intensity = 0.0;
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("SUN");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (sun->dictionary_owner_soft));
}
...
)
{
        ...
        sun->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (sun);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (sun->object_owner_soft));
}
...
)
{
        ...
        sun->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (sun);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (sun->dictionary_owner_hard));
}
...
)
{
        ...
        sun->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (sun);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (sun->plot_style_name));
}
...
)
{
        ...
        sun->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (sun);
...
)
{
        ...
        sun->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (sun);
