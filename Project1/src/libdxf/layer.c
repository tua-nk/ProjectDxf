...
)
{
        ...
        dxf_layer_set_layer_name (layer, _strdup (""));
        dxf_layer_set_linetype (layer, _strdup (DXF_DEFAULT_LINETYPE));
        dxf_layer_set_color (layer, DXF_COLOR_BYLAYER);
        dxf_layer_set_flag (layer, 0);
        dxf_layer_set_plotting_flag (layer, 0);
        dxf_layer_set_dictionary_owner_soft (layer, _strdup (""));
        dxf_layer_set_material (layer, _strdup (""));
        dxf_layer_set_dictionary_owner_hard (layer, _strdup (""));
        dxf_layer_set_lineweight (layer, 0);
        dxf_layer_set_plot_style_name (layer, _strdup (""));
...
)
{
        ...
        {
                layer->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        }
        /* Clean up. */
        free (temp_string);
#if DEBUG
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("LAYER");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (layer->layer_name));
}
...
)
{
        ...
        layer->layer_name = _strdup (layer_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (layer);
...
)
{
        ...
        layer->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (layer);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (layer->dictionary_owner_soft));
}
...
)
{
        ...
        layer->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (layer);
...
)
{
        ...
        layer->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (layer);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (layer->dictionary_owner_hard));
}
...
)
{
        ...
        layer->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (layer);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (layer->plot_style_name));
}
...
)
{
        ...
        layer->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (layer);
