...
)
{
        ...
        face->id_code = 0;
        face->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        face->layer = _strdup (DXF_DEFAULT_LAYER);
        face->elevation = 0.0;
        face->thickness = 0.0;
        ...
        face->shadow_mode = 0;
        face->dictionary_owner_soft = _strdup ("");
        face->object_owner_soft = _strdup ("");
        face->material = _strdup ("");
        face->dictionary_owner_hard = _strdup ("");
        face->lineweight = 0;
        face->plot_style_name = _strdup ("");
        face->color_value = 0;
        face->color_name = _strdup ("");
        face->transparency = 0;
        face->flag = 0;
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("3DFACE");
...
)
{
        ...
        face->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (face);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (face->dictionary_owner_soft));
}
...
)
{
        ...
        face->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (face);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (face->object_owner_soft));
}
...
)
{
        ...
        face->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (face);
...
)
{
        ...
        face->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (face);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (face->dictionary_owner_hard));
}
...
)
{
        ...
        face->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (face);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (face->plot_style_name));
}
...
)
{
        ...
        face->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (face);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (face->color_name));
}
...
)
{
        ...
        face->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (face);
...
)
{
        ...
        switch (inheritance)
        {
                ...
                case 1:
                        ...
                        {
                                face->linetype = _strdup (p0->linetype);
                        }
                        if (p0->layer == NULL)
                        {
                                fprintf (stderr,
                        ...
                        {
                                face->dictionary_owner_soft = _strdup (p0->dictionary_owner_soft);
                        }
                        ...
                        {
                                face->object_owner_soft = _strdup (p0->object_owner_soft);
                        }
                        if (p0->material == NULL)
                        {
                                fprintf (stderr,
                        ...
                        {
                                face->material = _strdup (p0->material);
                        }
                        ...
                        {
                                face->dictionary_owner_hard = _strdup (p0->dictionary_owner_hard);
                        }
                        ...
                        {
                                face->plot_style_name = _strdup (p0->plot_style_name);
                        }
                        ...
                        {
                                face->color_name = _strdup (p0->color_name);
                        }
                ...
                case 2:
                        ...
                        {
                                face->linetype = _strdup (p1->linetype);
                        }
                        if (p1->layer == NULL)
                        {
                                fprintf (stderr,
                        ...
                        {
                                face->dictionary_owner_soft = _strdup (p1->dictionary_owner_soft);
                        }
                        ...
                        {
                                face->object_owner_soft = _strdup (p1->object_owner_soft);
                        }
                        if (p1->material == NULL)
                        {
                                fprintf (stderr,
                        ...
                        {
                                face->material = _strdup (p1->material);
                        }
                        ...
                        {
                                face->dictionary_owner_hard = _strdup (p1->dictionary_owner_hard);
                        }
                        ...
                        {
                                face->plot_style_name = _strdup (p1->plot_style_name);
                        }
                        ...
                        {
                                face->color_name = _strdup (p1->color_name);
                        }
                ...
                case 3:
                        ...
                        {
                                face->linetype = _strdup (p2->linetype);
                        }
                        if (p2->layer == NULL)
                        {
                                fprintf (stderr,
                        ...
                        {
                                face->dictionary_owner_soft = _strdup (p2->dictionary_owner_soft);
                        }
                        ...
                        {
                                face->object_owner_soft = _strdup (p2->object_owner_soft);
                        }
                        if (p2->material == NULL)
                        {
                                fprintf (stderr,
                        ...
                        {
                                face->material = _strdup (p2->material);
                        }
                        ...
                        {
                                face->dictionary_owner_hard = _strdup (p2->dictionary_owner_hard);
                        }
                        ...
                        {
                                face->plot_style_name = _strdup (p2->plot_style_name);
                        }
                        ...
                        {
                                face->color_name = _strdup (p2->color_name);
                        }
                ...
                case 4:
                        ...
                        {
                                face->linetype = _strdup (p3->linetype);
                        }
                        if (p3->layer == NULL)
                        {
                                fprintf (stderr,
                        ...
                        {
                                face->dictionary_owner_soft = _strdup (p3->dictionary_owner_soft);
                        }
                        ...
                        {
                                face->object_owner_soft = _strdup (p3->object_owner_soft);
                        }
                        if (p3->material == NULL)
                        {
                                fprintf (stderr,
                        ...
                        {
                                face->material = _strdup (p3->material);
                        }
                        ...
                        {
                                face->dictionary_owner_hard = _strdup (p3->dictionary_owner_hard);
                        }
                        ...
                        {
                                face->plot_style_name = _strdup (p3->plot_style_name);
                        }
                        ...
                        {
                                face->color_name = _strdup (p3->color_name);
                        }
