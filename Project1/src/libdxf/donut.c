...
)
{
        ...
        donut->id_code = 0;
        donut->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        donut->layer = _strdup (DXF_DEFAULT_LAYER);
        donut->elevation = 0.0;
        donut->thickness = 0.0;
        ...
        donut->shadow_mode = 0;
        donut->dictionary_owner_soft = _strdup ("");
        donut->material = _strdup ("");
        donut->dictionary_owner_hard = _strdup ("");
        donut->lineweight = 0;
        donut->plot_style_name = _strdup ("");
        donut->color_value = 0;
        donut->color_name = _strdup ("");
...
)
{
        ...
        if (strcmp (dxf_donut_get_linetype (donut), "") == 0)
        {
                ...
                fprintf (stderr,
                  ...
                  dxf_entity_name);
                dxf_donut_set_linetype (donut, _strdup (DXF_DEFAULT_LINETYPE));
        }
        if (strcmp (dxf_donut_get_layer (donut), "") == 0)
        {
                ...
                fprintf (stderr,
                  ...
                  dxf_entity_name);
                dxf_donut_set_layer (donut, _strdup (DXF_DEFAULT_LAYER));
        }
...
)
{
        ...
        donut->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (donut);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (donut->dictionary_owner_soft));
}
...
)
{
        ...
        donut->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (donut);
...
)
{
        ...
        donut->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (donut);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (donut->dictionary_owner_hard));
}
...
)
{
        ...
        donut->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (donut);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (donut->plot_style_name));
}
...
)
{
        ...
        donut->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (donut);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (donut->color_name));
}
...
)
{
        ...
        donut->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (donut);
