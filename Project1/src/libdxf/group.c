...
)
{
        ...
        group->id_code = 0;
        group->description = _strdup ("");
        group->handle_entity_in_group = _strdup ("");
        group->unnamed_flag = 0;
        group->selectability_flag = 0;
        group->dictionary_owner_soft = _strdup ("");
        group->dictionary_owner_hard = _strdup ("");
        group->next = NULL;
#if DEBUG
        DXF_DEBUG_END
#endif
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("GROUP");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (group->dictionary_owner_soft));
}
...
)
{
        ...
        group->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (group);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (group->object_owner_soft));
}
...
)
{
        ...
        group->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (group);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (group->dictionary_owner_hard));
}
...
)
{
        ...
        group->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (group);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (group->description));
}
...
)
{
        ...
        group->description = _strdup (description);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (group);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (group->handle_entity_in_group));
}
...
)
{
        ...
        group->handle_entity_in_group = _strdup (handle_entity_in_group);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (group);
