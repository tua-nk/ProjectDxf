...
)
{
        ...
        dxf_mlinestyle_set_name (mlinestyle, _strdup (""));
        dxf_mlinestyle_set_description (mlinestyle, _strdup (""));
        dxf_mlinestyle_set_id_code (mlinestyle, 0);
        dxf_mlinestyle_set_dictionary_owner_soft (mlinestyle, _strdup (""));
        dxf_mlinestyle_set_dictionary_owner_hard (mlinestyle, _strdup (""));
        ...
        {
                dxf_mlinestyle_set_ith_element_linetype (mlinestyle, _strdup (""), i);
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("MLINESTYLE");
        int i;
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mlinestyle->dictionary_owner_soft));
}
...
)
{
        ...
        mlinestyle->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mlinestyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mlinestyle->dictionary_owner_hard));
}
...
)
{
        ...
        mlinestyle->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mlinestyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mlinestyle->name));
}
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mlinestyle->description));
}
...
)
{
        ...
        mlinestyle->description = _strdup (description);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mlinestyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mlinestyle->element_linetype[i]));
}
...
)
{
        ...
        mlinestyle->element_linetype[i] = _strdup (element_linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mlinestyle);
