...
)
{
        ...
        spatial_index->dictionary_owner_soft = _strdup ("");
        spatial_index->dictionary_owner_hard = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("SPATIAL_INDEX");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (spatial_index->dictionary_owner_soft));
}
...
)
{
        ...
        spatial_index->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (spatial_index);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (spatial_index->dictionary_owner_hard));
}
...
)
{
        ...
        spatial_index->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (spatial_index);
