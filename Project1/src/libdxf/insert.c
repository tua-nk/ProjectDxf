...
)
{
        ...
        insert->id_code = 0;
        insert->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        insert->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        insert->dictionary_owner_soft = _strdup ("");
        insert->material = _strdup ("");
        insert->dictionary_owner_hard = _strdup ("");
        insert->lineweight = 0.0;
        insert->plot_style_name = _strdup ("");
        insert->color_value = 0;
        insert->color_name = _strdup ("");
        insert->transparency = 0;
        insert->block_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("INSERT");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (insert->linetype));
}
...
)
{
        ...
        insert->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (insert);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (insert->dictionary_owner_soft));
}
...
)
{
        ...
        insert->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (insert);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (insert->material));
}
...
)
{
        ...
        insert->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (insert);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (insert->dictionary_owner_hard));
}
...
)
{
        ...
        insert->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (insert);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (insert->plot_style_name));
}
...
)
{
        ...
        insert->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (insert);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (insert->color_name));
}
...
)
{
        ...
        insert->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (insert);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (insert->block_name));
}
...
)
{
        ...
        insert->block_name = _strdup (block_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (insert);
