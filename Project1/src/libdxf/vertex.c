...
)
{
        ...
        vertex->id_code = 0;
        vertex->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        vertex->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        vertex->dictionary_owner_soft = _strdup ("");
        vertex->material = _strdup ("");
        vertex->dictionary_owner_hard = _strdup ("");
        vertex->lineweight = 0;
        vertex->plot_style_name = _strdup ("");
        vertex->color_value = 0;
        vertex->color_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("VERTEX");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (vertex->linetype));
}
...
)
{
        ...
        vertex->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (vertex);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (vertex->dictionary_owner_soft));
}
...
)
{
        ...
        vertex->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (vertex);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (vertex->material));
}
...
)
{
        ...
        vertex->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (vertex);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (vertex->dictionary_owner_hard));
}
...
)
{
        ...
        vertex->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (vertex);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (vertex->plot_style_name));
}
...
)
{
        ...
        vertex->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (vertex);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (vertex->color_name));
}
...
)
{
        ...
        vertex->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (vertex);
