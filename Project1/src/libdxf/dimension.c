...
)
{
        ...
        dimension->id_code = 0;
        dimension->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        dimension->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        dimension->dictionary_owner_soft = _strdup ("");
        dimension->object_owner_soft = _strdup ("");
        dimension->material = _strdup ("");
        dimension->dictionary_owner_hard = _strdup ("");
        dimension->lineweight = 0;
        dimension->plot_style_name = _strdup ("");
        dimension->color_value = 0;
        dimension->color_name = _strdup ("");
        dimension->transparency = 0;
        dimension->dim_text = _strdup ("");
        dimension->dimblock_name = _strdup ("");
        dimension->dimstyle_name = _strdup ("");
        dimension->p0->x0 = 0.0;
        dimension->p0->y0 = 0.0;
        dimension->p0->z0 = 0.0;
        dimension->p1->x0 = 0.0;
...
)
{
        ...
        {
                dxf_dimension_set_linetype (dimension, _strdup (DXF_DEFAULT_LINETYPE));
        }
        if (strcmp (dxf_dimension_get_layer (dimension), "") == 0)
        {
                dxf_dimension_set_layer (dimension, _strdup (DXF_DEFAULT_LAYER));
        }
        /* Clean up. */
        free (temp_string);
#if DEBUG
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("DIMENSION");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimension->linetype));
}
...
)
{
        ...
        dimension->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimension);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimension->layer));
}
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimension->dictionary_owner_soft));
}
...
)
{
        ...
        dimension->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimension);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimension->object_owner_soft));
}
...
)
{
        ...
        dimension->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimension);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimension->material));
}
...
)
{
        ...
        dimension->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimension);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimension->dictionary_owner_hard));
}
...
)
{
        ...
        dimension->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimension);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimension->plot_style_name));
}
...
)
{
        ...
        dimension->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimension);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimension->color_name));
}
...
)
{
        ...
        dimension->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimension);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimension->dim_text));
}
...
)
{
        ...
        dimension->dim_text = _strdup (dim_text);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimension);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimension->dimblock_name));
}
...
)
{
        ...
        dimension->dimblock_name = _strdup (dimblock_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimension);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimension->dimstyle_name));
}
...
)
{
        ...
        dimension->dimblock_name = _strdup (dimstyle_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimension);
