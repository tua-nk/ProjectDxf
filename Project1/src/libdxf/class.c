...
)
{
        ...
        class->record_type = _strdup ("");
        class->record_name = _strdup ("");
        class->class_name = _strdup ("");
        class->app_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("CLASS");
...
)
{
        ...
        result = _strdup (class->record_type);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (result);
...
)
{
        ...
        class->record_type = _strdup (record_type);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (class);
...
)
{
        ...
        result = _strdup (class->record_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (result);
...
)
{
        ...
        class->record_name = _strdup (record_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (class);
...
)
{
        ...
        result = _strdup (class->class_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (result);
...
)
{
        ...
        class->class_name = _strdup (class_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (class);
...
)
{
        ...
        class->app_name = _strdup (app_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (class);
