...
)
{
        ...
        text->id_code = 0;
        text->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        text->layer = _strdup (DXF_DEFAULT_LAYER);
        text->elevation = 0.0;
        text->thickness = 0.0;
        ...
        text->dictionary_owner_soft = _strdup ("");
        text->material = _strdup ("");
        text->dictionary_owner_hard = _strdup ("");
        text->lineweight = 0;
        text->plot_style_name = _strdup ("");
        text->color_value = 0;
        text->color_name = _strdup ("");
        text->transparency = 0;
        text->text_value = _strdup ("");
        text->text_style = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("TEXT");
...
)
{
        ...
        if (strcmp (text->text_style, "") == 0)
        {
                fprintf (stderr,
                  ...
                  __FUNCTION__, dxf_entity_name, text->id_code);
                text->text_style = _strdup (DXF_DEFAULT_TEXTSTYLE);        }
        if (strcmp (text->layer, "") == 0)
        {
                fprintf (stderr,
...
)
{
        ...
        text->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (text);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (text->dictionary_owner_soft));
}
...
)
{
        ...
        text->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (text);
...
)
{
        ...
        text->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (text);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (text->dictionary_owner_hard));
}
...
)
{
        ...
        text->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (text);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (text->plot_style_name));
}
...
)
{
        ...
        text->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (text);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (text->color_name));
}
...
)
{
        ...
        text->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (text);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (text->text_value));
}
...
)
{
        ...
        text->text_value = _strdup (text_value);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (text);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (text->text_style));
}
...
)
{
        ...
        text->text_style = _strdup (text_style);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (text);
