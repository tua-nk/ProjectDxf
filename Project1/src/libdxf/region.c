...
)
{
        ...
        region->id_code = 0;
        region->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        region->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        region->proprietary_data->value = _strdup ("");
        ...
        region->additional_proprietary_data->value = _strdup ("");
        region->additional_proprietary_data->length = 0;
        region->additional_proprietary_data->next = NULL;
        region->dictionary_owner_soft = _strdup ("");
        region->dictionary_owner_hard = _strdup ("");
        region->next = NULL;
#if DEBUG
        DXF_DEBUG_END
#endif
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("REGION");
        DxfChar *iter1 = NULL;
        DxfChar *iter2 = NULL;
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (region->linetype));
}
...
)
{
        ...
        region->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (region);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (region->dictionary_owner_soft));
}
...
)
{
        ...
        region->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (region);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (region->material));
}
...
)
{
        ...
        region->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (region);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (region->dictionary_owner_hard));
}
...
)
{
        ...
        region->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (region);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (region->plot_style_name));
}
...
)
{
        ...
        region->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (region);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (region->color_name));
}
...
)
{
        ...
        region->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (region);
