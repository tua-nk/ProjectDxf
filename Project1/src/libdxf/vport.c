...
)
{
        ...
        vport->dictionary_owner_soft = _strdup ("");
        vport->dictionary_owner_hard = _strdup ("");
        vport->next = NULL;
#if DEBUG
        DXF_DEBUG_END
#endif
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("VPORT");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (vport->viewport_name));
}
...
)
{
        ...
        vport->viewport_name = _strdup (viewport_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (vport);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (vport->dictionary_owner_soft));
}
...
)
{
        ...
        vport->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (vport);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (vport->dictionary_owner_hard));
}
...
)
{
        ...
        vport->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (vport);
