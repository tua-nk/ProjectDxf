...
)
{
        ...
        dimstyle->dimstyle_name = _strdup ("");
        dimstyle->dimpost = _strdup ("");
        dimstyle->dimapost = _strdup ("");
        dimstyle->dimblk = _strdup ("");
        dimstyle->dimblk1 = _strdup ("");
        dimstyle->dimblk2 = _strdup ("");
        ...
        dimstyle->dictionary_owner_soft = _strdup ("");
        dimstyle->object_owner_soft = _strdup ("");
        dimstyle->dictionary_owner_hard = _strdup ("");
        dimstyle->next = NULL;
#if DEBUG
        DXF_DEBUG_END
#endif
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("DIMSTYLE");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimstyle->dimstyle_name));
}
...
)
{
        ...
        dimstyle->dimstyle_name = _strdup (dimstyle_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimstyle->dimpost));
}
...
)
{
        ...
        dimstyle->dimpost = _strdup (dimpost);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimstyle->dimapost));
}
...
)
{
        ...
        dimstyle->dimapost = _strdup (dimapost);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimstyle->dimblk));
}
...
)
{
        ...
        dimstyle->dimblk = _strdup (dimblk);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimstyle->dimblk1));
}
...
)
{
        ...
        dimstyle->dimblk1 = _strdup (dimblk1);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimstyle->dimblk2));
}
...
)
{
        ...
        dimstyle->dimblk2 = _strdup (dimblk2);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimstyle->dictionary_owner_soft));
}
...
)
{
        ...
        dimstyle->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimstyle->object_owner_soft));
}
...
)
{
        ...
        dimstyle->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimstyle->dictionary_owner_hard));
}
...
)
{
        ...
        dimstyle->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dimstyle->dimtxsty));
}
...
)
{
        ...
        dimstyle->dimtxsty = _strdup (dimtxsty);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dimstyle);
