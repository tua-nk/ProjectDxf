...
)
{
        ...
        appid->id_code = 0;
        appid->application_name = _strdup ("");
        appid->flag = 0;
        appid->dictionary_owner_soft = _strdup ("");
        appid->object_owner_soft = _strdup ("");
        appid->dictionary_owner_hard = _strdup ("");
        appid->next = NULL;
#if DEBUG
        DXF_DEBUG_END
#endif
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("APPID");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (appid->application_name));
}
...
)
{
        ...
        appid->application_name = _strdup (name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (appid);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (appid->dictionary_owner_soft));
}
...
)
{
        ...
        appid->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (appid);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (appid->object_owner_soft));
}
...
)
{
        ...
        appid->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (appid);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (appid->dictionary_owner_hard));
}
...
)
{
        ...
        appid->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (appid);
