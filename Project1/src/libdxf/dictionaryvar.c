...
)
{
        ...
        dxf_dictionaryvar_set_value (dictionaryvar, _strdup (""));
        dxf_dictionaryvar_set_object_schema_number (dictionaryvar, _strdup (""));
        dxf_dictionaryvar_set_dictionary_owner_soft (dictionaryvar, _strdup (""));
        dxf_dictionaryvar_set_dictionary_owner_hard (dictionaryvar, _strdup (""));
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("DICTIONARYVAR");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dictionaryvar->dictionary_owner_soft));
}
...
)
{
        ...
        dictionaryvar->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dictionaryvar);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dictionaryvar->dictionary_owner_hard));
}
...
)
{
        ...
        dictionaryvar->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dictionaryvar);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dictionaryvar->value));
}
...
)
{
        ...
        dictionaryvar->value = _strdup (value);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dictionaryvar);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dictionaryvar->object_schema_number));
}
...
)
{
        ...
        dictionaryvar->object_schema_number = _strdup (object_schema_number);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dictionaryvar);
