...
)
{
        ...
        ucs->elevation = 0.0;
        ucs->dictionary_owner_soft = _strdup ("");
        ucs->object_owner_soft = _strdup ("");
        ucs->base_UCS = _strdup ("");
        ucs->dictionary_owner_hard = _strdup ("");
        ucs->next = NULL;
#if DEBUG
        DXF_DEBUG_END
#endif
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("UCS");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ucs->dictionary_owner_soft));
}
...
)
{
        ...
        ucs->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ucs);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ucs->object_owner_soft));
}
...
)
{
        ...
        ucs->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ucs);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ucs->dictionary_owner_hard));
}
...
)
{
        ...
        ucs->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ucs);
