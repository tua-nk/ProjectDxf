...
)
{
        ...
        spatial_filter->dictionary_owner_soft = _strdup ("");
        spatial_filter->dictionary_owner_hard = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("SPATIAL_FILTER");
        int i;
        DxfPoint *iter_p0 = NULL;
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (spatial_filter->dictionary_owner_soft));
}
...
)
{
        ...
        spatial_filter->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (spatial_filter);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (spatial_filter->dictionary_owner_hard));
}
...
)
{
        ...
        spatial_filter->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (spatial_filter);
