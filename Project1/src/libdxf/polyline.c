...
)
{
        ...
        dxf_polyline_set_linetype (polyline, _strdup (DXF_DEFAULT_LINETYPE));
        dxf_polyline_set_layer (polyline, _strdup (DXF_DEFAULT_LAYER));
        ...
        dxf_polyline_set_dictionary_owner_soft (polyline, _strdup (""));
        dxf_polyline_set_material (polyline, _strdup (""));
        dxf_polyline_set_dictionary_owner_hard (polyline, _strdup (""));
        dxf_polyline_set_lineweight (polyline, 0);
        dxf_polyline_set_plot_style_name (polyline, _strdup (""));
        dxf_polyline_set_color_value (polyline, 0);
        dxf_polyline_set_color_name (polyline, _strdup (""));
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("POLYLINE");
        DxfVertex *iter = NULL;
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (polyline->linetype));
}
...
)
{
        ...
        polyline->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (polyline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (polyline->dictionary_owner_soft));
}
...
)
{
        ...
        polyline->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (polyline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (polyline->material));
}
...
)
{
        ...
        polyline->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (polyline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (polyline->dictionary_owner_hard));
}
...
)
{
        ...
        polyline->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (polyline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (polyline->plot_style_name));
}
...
)
{
        ...
        polyline->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (polyline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (polyline->color_name));
}
...
)
{
        ...
        polyline->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (polyline);
