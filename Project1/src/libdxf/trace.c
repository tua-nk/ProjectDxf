...
)
{
        ...
        trace->id_code = 0;
        trace->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        trace->layer = _strdup (DXF_DEFAULT_LAYER);
        trace->elevation = 0.0;
        trace->thickness = 0.0;
        ...
        trace->dictionary_owner_soft = _strdup ("");
        trace->material = _strdup ("");
        trace->dictionary_owner_hard = _strdup ("");
        trace->lineweight = 0;
        trace->plot_style_name = _strdup ("");
        trace->color_value = 0;
        trace->color_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("TRACE");
...
)
{
        ...
        trace->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (trace);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (trace->dictionary_owner_soft));
}
...
)
{
        ...
        trace->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (trace);
...
)
{
        ...
        trace->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (trace);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (trace->dictionary_owner_hard));
}
...
)
{
        ...
        trace->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (trace);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (trace->plot_style_name));
}
...
)
{
        ...
        trace->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (trace);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (trace->color_name));
}
...
)
{
        ...
        trace->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (trace);
