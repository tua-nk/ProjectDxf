...
)
{
        ...
        xline->id_code = 0;
        xline->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        xline->layer = _strdup (DXF_DEFAULT_LAYER);
        xline->elevation = 0.0;
        xline->thickness = 0.0;
        ...
        xline->dictionary_owner_soft = _strdup ("");
        xline->material = _strdup ("");
        xline->dictionary_owner_hard = _strdup ("");
        xline->lineweight = 0;
        xline->plot_style_name = _strdup ("");
        xline->color_value = 0;
        xline->color_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("XLINE");
...
)
{
        ...
        xline->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (xline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (xline->dictionary_owner_soft));
}
...
)
{
        ...
        xline->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (xline);
...
)
{
        ...
        xline->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (xline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (xline->dictionary_owner_hard));
}
...
)
{
        ...
        xline->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (xline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (xline->plot_style_name));
}
...
)
{
        ...
        xline->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (xline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (xline->color_name));
}
...
)
{
        ...
        xline->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (xline);
