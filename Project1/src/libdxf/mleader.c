...
)
{
        ...
        mleader->id_code = 0;
        mleader->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        mleader->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        mleader->dictionary_owner_soft = _strdup ("");
        mleader->object_owner_soft = _strdup ("");
        mleader->material = _strdup ("");
        mleader->dictionary_owner_hard = _strdup ("");
        mleader->lineweight = 0;
        mleader->plot_style_name = _strdup ("");
        mleader->color_value = 0;
        mleader->color_name = _strdup ("");
        ...
        mleader->block_attribute_text_string = _strdup ("");
        mleader->block_attribute_id = _strdup ("");
        mleader->leader_style_id = _strdup ("");
        mleader->arrowhead_id = _strdup ("");
        mleader->text_style_id = _strdup ("");
        mleader->block_content_id = _strdup ("");
        mleader->arrow_head_id = _strdup ("");
        mleader->next = NULL;
#if DEBUG
        DXF_DEBUG_END
#endif
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("MLEADER");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->linetype));
}
...
)
{
        ...
        mleader->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->dictionary_owner_soft));
}
...
)
{
        ...
        mleader->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->object_owner_soft));
}
...
)
{
        ...
        mleader->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->material));
}
...
)
{
        ...
        mleader->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->dictionary_owner_hard));
}
...
)
{
        ...
        mleader->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->plot_style_name));
}
...
)
{
        ...
        mleader->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->color_name));
}
...
)
{
        ...
        mleader->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->block_attribute_text_string));
}
...
)
{
        ...
        mleader->block_attribute_text_string = _strdup (block_attribute_text_string);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->block_attribute_id));
}
...
)
{
        ...
        mleader->block_attribute_id = _strdup (block_attribute_id);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->leader_style_id));
}
...
)
{
        ...
        mleader->leader_style_id = _strdup (leader_style_id);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->leader_linetype_id));
}
...
)
{
        ...
        mleader->leader_linetype_id = _strdup (leader_linetype_id);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->arrowhead_id));
}
...
)
{
        ...
        mleader->arrowhead_id = _strdup (arrowhead_id);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->text_style_id));
}
...
)
{
        ...
        mleader->text_style_id = _strdup (text_style_id);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->block_content_id));
}
...
)
{
        ...
        mleader->block_content_id = _strdup (block_content_id);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleader->arrow_head_id));
}
...
)
{
        ...
        mleader->arrow_head_id = _strdup (arrow_head_id);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleader);
...
)
{
        ...
        data->default_text_contents = _strdup ("");
        data->type_style_id = _strdup ("");
        data->block_content_id = _strdup ("");
        data->next = NULL;
#if DEBUG
        DXF_DEBUG_END
#endif
