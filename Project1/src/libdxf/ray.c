...
)
{
        ...
        ray->id_code = 0;
        ray->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        ray->layer = _strdup (DXF_DEFAULT_LAYER);
        ray->elevation = 0.0;
        ray->thickness = 0.0;
        ...
        ray->dictionary_owner_soft = _strdup ("");
        ray->material = _strdup ("");
        ray->dictionary_owner_hard = _strdup ("");
        ray->lineweight = 0;
        ray->plot_style_name = _strdup ("");
        ray->color_value = 0;
        ray->color_name = _strdup ("");
        ray->transparency = 0;
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("RAY");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ray->dictionary_owner_soft));
}
...
)
{
        ...
        ray->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ray);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ray->dictionary_owner_hard));
}
...
)
{
        ...
        ray->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ray);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ray->plot_style_name));
}
...
)
{
        ...
        ray->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ray);
...
)
{
        ...
        ray->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ray);
