...
)
{
        ...
        spline->id_code = 0;
        spline->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        spline->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        spline->dictionary_owner_soft = _strdup ("");
        spline->material = _strdup ("");
        spline->dictionary_owner_hard = _strdup ("");
        spline->lineweight = 0;
        spline->plot_style_name = _strdup ("");
        spline->color_value = 0;
        spline->color_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("SPLINE");
        int i;
        DxfBinaryGraphicsData *binary_graphics_data = NULL;
        DxfPoint *p0 = NULL;
        DxfPoint *p1 = NULL;
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (spline->linetype));
}
...
)
{
        ...
        spline->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (spline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (spline->dictionary_owner_soft));
}
...
)
{
        ...
        spline->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (spline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (spline->material));
}
...
)
{
        ...
        spline->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (spline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (spline->dictionary_owner_hard));
}
...
)
{
        ...
        spline->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (spline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (spline->plot_style_name));
}
...
)
{
        ...
        spline->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (spline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (spline->color_name));
}
...
)
{
        ...
        spline->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (spline);
