...
)
{
        ...
        surface->id_code = 0;
        surface->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        surface->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        surface->dictionary_owner_soft = _strdup ("");
        surface->object_owner_soft = _strdup ("");
        surface->material = _strdup ("");
        surface->dictionary_owner_hard = _strdup ("");
        surface->lineweight = 0;
        surface->plot_style_name = _strdup ("");
        surface->color_value = 0;
        surface->color_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("SURFACE");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (surface->linetype));
}
...
)
{
        ...
        surface->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (surface);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (surface->dictionary_owner_soft));
}
...
)
{
        ...
        surface->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (surface);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (surface->object_owner_soft));
}
...
)
{
        ...
        surface->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (surface);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (surface->material));
}
...
)
{
        ...
        surface->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (surface);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (surface->dictionary_owner_hard));
}
...
)
{
        ...
        surface->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (surface);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (surface->plot_style_name));
}
...
)
{
        ...
        surface->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (surface);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (surface->color_name));
}
...
)
{
        ...
        surface->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (surface);
