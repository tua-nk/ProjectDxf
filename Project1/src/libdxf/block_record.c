...
)
{
        ...
        block_record->block_name = _strdup ("");
        block_record->flag = 0;
        block_record->insert_units = 0;
        block_record->explodability = 0;
        block_record->scalability = 0;
        block_record->dictionary_owner_soft = _strdup ("");
        block_record->object_owner_soft = _strdup ("");
        block_record->dictionary_owner_hard = _strdup ("");
        block_record->xdata_string_data = _strdup ("DesignCenter Data");
        block_record->xdata_application_name = _strdup ("ACAD");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("BLOCK_RECORD");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (block_record->block_name));
}
...
)
{
        ...
        block_record->block_name= _strdup (block_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (block_record);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (block_record->dictionary_owner_soft));
}
...
)
{
        ...
        block_record->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (block_record);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (block_record->object_owner_soft));
}
...
)
{
        ...
        block_record->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (block_record);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (block_record->associated_layout_hard));
}
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (block_record->dictionary_owner_hard));
}
...
)
{
        ...
        block_record->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (block_record);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (block_record->xdata_string_data));
}
...
)
{
        ...
        block_record->xdata_string_data = _strdup (xdata_string_data);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (block_record);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (block_record->xdata_application_name));
}
...
)
{
        ...
        block_record->xdata_application_name = _strdup (xdata_application_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (block_record);
