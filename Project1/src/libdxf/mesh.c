...
)
{
        ...
        mesh->id_code = 0;
        mesh->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        mesh->layer = _strdup (DXF_DEFAULT_LAYER);
        mesh->elevation = 0.0;
        mesh->thickness = 0.0;
        ...
        mesh->shadow_mode = 0;
        mesh->dictionary_owner_soft = _strdup ("");
        mesh->object_owner_soft = _strdup ("");
        mesh->material = _strdup ("");
        mesh->dictionary_owner_hard = _strdup ("");
        mesh->lineweight = 0;
        mesh->plot_style_name = _strdup ("");
        mesh->color_value = 0;
        mesh->color_name = _strdup ("");
        mesh->transparency = 0;
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("MESH");
...
)
{
        ...
        mesh->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mesh);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mesh->dictionary_owner_soft));
}
...
)
{
        ...
        mesh->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mesh);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mesh->object_owner_soft));
}
...
)
{
        ...
        mesh->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mesh);
...
)
{
        ...
        mesh->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mesh);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mesh->dictionary_owner_hard));
}
...
)
{
        ...
        mesh->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mesh);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mesh->plot_style_name));
}
...
)
{
        ...
        mesh->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mesh);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mesh->color_name));
}
...
)
{
        ...
        mesh->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mesh);
