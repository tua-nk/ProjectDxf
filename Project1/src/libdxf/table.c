...
)
{
        ...
        cell->text_string = _strdup ("");
        for (i = 0; i < DXF_MAX_PARAM; i++)
        {
                cell->optional_text_string[i] = _strdup ("");
                cell->attdef_soft_pointer[i] = _strdup ("");
        }
        cell->text_style_name = _strdup (DXF_DEFAULT_TEXTSTYLE);
        cell->color_bg = 0;
        ...
        cell->attdef_text_string = _strdup ("");
        cell->block_table_record_hard_pointer = _strdup ("");
        cell->field_object_pointer = _strdup ("");
        cell->next = NULL;
#if DEBUG
        DXF_DEBUG_END
#endif
...
)
{
        ...
        table->id_code = 0;
        table->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        table->layer = _strdup (DXF_DEFAULT_LAYER);
        table->elevation = 0.0;
        table->thickness = 0.0;
        table->visibility = 0;
        ...
        table->dictionary_owner_soft = _strdup ("");
        table->dictionary_owner_hard = _strdup ("");
        table->block_name = _strdup ("");
        table->table_text_style_name = _strdup ("");
        ...
        table->tablestyle_object_pointer = _strdup ("");
        table->owning_block_pointer = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("ACAD_TABLE");
        int i;
        ...
        if (table->linetype == NULL)
        {
                ...
                table->layer = _strdup (DXF_DEFAULT_LINETYPE);
        }
        /* Start writing output. */
        fprintf (fp->fp, "  0\n%s\n", dxf_entity_name);
        if (table->id_code != -1)
...
)
{
        ...
        table->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (table);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (table->dictionary_owner_soft));
}
...
)
{
        ...
        table->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (table);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (table->object_owner_soft));
}
...
)
{
        ...
        table->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (table);
...
)
{
        ...
        table->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (table);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (table->dictionary_owner_hard));
}
...
)
{
        ...
        table->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (table);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (table->plot_style_name));
}
...
)
{
        ...
        table->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (table);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (table->color_name));
}
...
)
{
        ...
        table->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (table);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (table->block_name));
}
...
)
{
        ...
        table->block_name = _strdup (block_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (table);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (table->table_text_style_name));
}
...
)
{
        ...
        table->table_text_style_name = _strdup (table_text_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (table);
