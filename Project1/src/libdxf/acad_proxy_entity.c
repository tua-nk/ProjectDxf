...
)
{
        ...
        acad_proxy_entity->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        acad_proxy_entity->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        acad_proxy_entity->dictionary_owner_soft = _strdup ("");
        acad_proxy_entity->object_owner_soft = _strdup ("");
        acad_proxy_entity->material = _strdup ("");
        acad_proxy_entity->dictionary_owner_hard = _strdup ("");
        acad_proxy_entity->lineweight = 0;
        acad_proxy_entity->plot_style_name = _strdup ("");
        acad_proxy_entity->color_value = 0;
        acad_proxy_entity->color_name = _strdup ("");
        ...
        acad_proxy_entity->object_id->data = _strdup ("");
...
)
{
        ...
        if (fp->acad_version_number <= AutoCAD_13)
        {
                dxf_entity_name = _strdup ("ACAD_ZOMBIE_ENTITY");
        }
        else if (fp->acad_version_number >= AutoCAD_14)
        {
                dxf_entity_name = _strdup ("ACAD_PROXY_ENTITY");
        }
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (acad_proxy_entity->linetype));
}
...
)
{
        ...
        acad_proxy_entity->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (acad_proxy_entity);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (acad_proxy_entity->layer));
}
...
)
{
        ...
        acad_proxy_entity->layer = _strdup (layer);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (acad_proxy_entity);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (acad_proxy_entity->dictionary_owner_soft));
}
...
)
{
        ...
        acad_proxy_entity->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (acad_proxy_entity);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (acad_proxy_entity->object_owner_soft));
}
...
)
{
        ...
        acad_proxy_entity->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (acad_proxy_entity);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (acad_proxy_entity->material));
}
...
)
{
        ...
        acad_proxy_entity->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (acad_proxy_entity);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (acad_proxy_entity->dictionary_owner_hard));
}
...
)
{
        ...
        acad_proxy_entity->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (acad_proxy_entity);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (acad_proxy_entity->plot_style_name));
}
...
)
{
        ...
        acad_proxy_entity->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (acad_proxy_entity);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (acad_proxy_entity->color_name));
}
...
)
{
        ...
        acad_proxy_entity->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (acad_proxy_entity);
