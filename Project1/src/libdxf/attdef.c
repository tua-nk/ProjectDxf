...
)
{
        ...
        attdef->id_code = 0;
        attdef->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        attdef->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        attdef->dictionary_owner_soft = _strdup ("");
        attdef->object_owner_soft = _strdup ("");
        attdef->material = _strdup ("");
        attdef->dictionary_owner_hard = _strdup ("");
        attdef->lineweight = 0.0;
        attdef->plot_style_name = _strdup ("");
        attdef->color_value = 0;
        attdef->color_name = _strdup ("");
        attdef->transparency = 0;
        attdef->default_value = _strdup ("");
        attdef->tag_value = _strdup ("");
        attdef->prompt_value = _strdup ("");
        attdef->text_style = _strdup (DXF_DEFAULT_TEXTSTYLE);
        attdef->height = 0.0;
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("ATTDEF");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attdef->linetype));
}
...
)
{
        ...
        attdef->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attdef);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attdef->dictionary_owner_soft));
}
...
)
{
        ...
        attdef->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attdef);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attdef->object_owner_soft));
}
...
)
{
        ...
        attdef->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attdef);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attdef->material));
}
...
)
{
        ...
        attdef->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attdef);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attdef->dictionary_owner_hard));
}
...
)
{
        ...
        attdef->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attdef);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attdef->plot_style_name));
}
...
)
{
        ...
        attdef->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attdef);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attdef->color_name));
}
...
)
{
        ...
        attdef->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attdef);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attdef->default_value));
}
...
)
{
        ...
        attdef->default_value = _strdup (default_value);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attdef);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attdef->tag_value));
}
...
)
{
        ...
        attdef->tag_value = _strdup (tag_value);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attdef);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attdef->prompt_value));
}
...
)
{
        ...
        attdef->prompt_value = _strdup (prompt_value);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attdef);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (attdef->text_style));
}
...
)
{
        ...
        attdef->text_style = _strdup (text_style);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (attdef);
