...
)
{
        ...
        xrecord->id_code = 0;
        xrecord->dictionary_owner_soft = _strdup ("");
        xrecord->dictionary_owner_hard = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("XRECORD");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (xrecord->dictionary_owner_soft));
}
...
)
{
        ...
        xrecord->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (xrecord);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (xrecord->dictionary_owner_hard));
}
...
)
{
        ...
        xrecord->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (xrecord);
