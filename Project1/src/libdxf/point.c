...
)
{
        ...
        point->id_code = 0;
        point->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        point->layer = _strdup (DXF_DEFAULT_LAYER);
        point->elevation = 0.0;
        point->thickness = 0.0;
        ...
        point->dictionary_owner_soft = _strdup ("");
        point->object_owner_soft = _strdup ("");
        point->material = _strdup ("");
        point->dictionary_owner_hard = _strdup ("");
        point->lineweight = 0;
        point->plot_style_name = _strdup ("");
        point->color_value = 0;
        point->color_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("POINT");
...
)
{
        ...
        point->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (point);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (point->dictionary_owner_soft));
}
...
)
{
        ...
        point->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (point);
...
)
{
        ...
        point->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (point);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (point->dictionary_owner_hard));
}
...
)
{
        ...
        point->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (point);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (point->plot_style_name));
}
...
)
{
        ...
        point->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (point);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (point->color_name));
}
...
)
{
        ...
        point->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (point);
