...
)
{
        ...
        helix->id_code = 0;
        helix->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        helix->layer = _strdup (DXF_DEFAULT_LAYER);
        helix->thickness = 0.0;
        helix->radius = 0.0;
        ...
        helix->shadow_mode = 0;
        helix->handedness = 0;
        helix->dictionary_owner_hard = _strdup ("");
        helix->material = _strdup ("");
        helix->dictionary_owner_soft = _strdup ("");
        helix->lineweight = 0;
        helix->plot_style_name = _strdup ("");
        helix->color_value = 0;
        helix->color_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("HELIX");
        int i;
        DxfPoint *iter = NULL;
...
)
{
        ...
        helix->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (helix);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (helix->dictionary_owner_soft));
}
...
)
{
        ...
        helix->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (helix);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (helix->object_owner_soft));
}
...
)
{
        ...
        helix->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (helix);
...
)
{
        ...
        helix->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (helix);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (helix->dictionary_owner_hard));
}
...
)
{
        ...
        helix->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (helix);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (helix->plot_style_name));
}
...
)
{
        ...
        helix->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (helix);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (helix->color_name));
}
...
)
{
        ...
        helix->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (helix);
