...
)
{
        ...
        endblk->id_code = 0;
        endblk->layer = _strdup (DXF_DEFAULT_LAYER);
        endblk->object_owner_soft = _strdup ("");
#if DEBUG
        DXF_DEBUG_END
#endif
        return (endblk);
...
)
{
        ...
        result = _strdup (endblk->object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (result);
...
)
{
        ...
        endblk->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (endblk);
