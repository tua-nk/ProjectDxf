...
)
{
        ...
        dictionary->dictionary_owner_soft = _strdup ("");
        dictionary->dictionary_owner_hard = _strdup ("");
        dictionary->entry_name = _strdup ("");
        dictionary->entry_object_handle = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("DICTIONARY");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dictionary->dictionary_owner_soft));
}
...
)
{
        ...
        dictionary->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dictionary);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dictionary->dictionary_owner_hard));
}
...
)
{
        ...
        dictionary->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dictionary);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dictionary->entry_name));
}
...
)
{
        ...
        dictionary->entry_name = _strdup (entry_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dictionary);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (dictionary->entry_object_handle));
}
...
)
{
        ...
        dictionary->entry_object_handle = _strdup (entry_object_handle);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (dictionary);
