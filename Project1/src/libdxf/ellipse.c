...
)
{
        ...
        ellipse->id_code = 0;
        ellipse->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        ellipse->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        ellipse->dictionary_owner_soft = _strdup ("");
        ellipse->object_owner_soft = _strdup ("");
        ellipse->material = _strdup ("");
        ellipse->dictionary_owner_hard = _strdup ("");
        ellipse->lineweight = 0;
        ellipse->plot_style_name = _strdup ("");
        ellipse->color_value = 0;
        ellipse->color_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("ELLIPSE");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ellipse->linetype));
}
...
)
{
        ...
        ellipse->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ellipse);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ellipse->dictionary_owner_soft));
}
...
)
{
        ...
        ellipse->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ellipse);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ellipse->object_owner_soft));
}
...
)
{
        ...
        ellipse->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ellipse);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ellipse->material));
}
...
)
{
        ...
        ellipse->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ellipse);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ellipse->dictionary_owner_hard));
}
...
)
{
        ...
        ellipse->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ellipse);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ellipse->plot_style_name));
}
...
)
{
        ...
        ellipse->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ellipse);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ellipse->color_name));
}
...
)
{
        ...
        ellipse->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ellipse);
