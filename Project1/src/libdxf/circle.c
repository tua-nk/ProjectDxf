...
)
{
        ...
        circle->id_code = 0;
        circle->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        circle->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        circle->dictionary_owner_soft = _strdup ("");
        circle->object_owner_soft = _strdup ("");
        circle->material = _strdup ("");
        circle->dictionary_owner_hard = _strdup ("");
        circle->lineweight = 0;
        circle->plot_style_name = _strdup ("");
        circle->color_value = 0;
        circle->color_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("CIRCLE");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (circle->linetype));
}
...
)
{
        ...
        circle->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (circle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (circle->dictionary_owner_soft));
}
...
)
{
        ...
        circle->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (circle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (circle->object_owner_soft));
}
...
)
{
        ...
        circle->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (circle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (circle->material));
}
...
)
{
        ...
        circle->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (circle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (circle->dictionary_owner_hard));
}
...
)
{
        ...
        circle->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (circle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (circle->plot_style_name));
}
...
)
{
        ...
        circle->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (circle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (circle->color_name));
}
...
)
{
        ...
        circle->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (circle);
