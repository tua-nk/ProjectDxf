...
)
{
        ...
        block->xref_name = _strdup ("");
        block->block_name = _strdup ("");
        block->block_name_additional = _strdup ("");
        block->description = _strdup ("");
        block->id_code = 0;
        block->layer = _strdup (DXF_DEFAULT_LAYER);
        block->p0->x0 = 0.0;
        block->p0->y0 = 0.0;
        block->p0->z0 = 0.0;
        ...
        block->extr_y0 = 0.0;
        block->extr_z0 = 0.0;
        block->object_owner_soft = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("BLOCK");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (block->xref_name));
}
...
)
{
        ...
        block->xref_name = _strdup (xref_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (block);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (block->block_name));
}
...
)
{
        ...
        block->block_name = _strdup (block_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (block);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (block->block_name_additional));
}
...
)
{
        ...
        block->block_name_additional = _strdup (block_name_additional);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (block);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (block->description));
}
...
)
{
        ...
        block->description = _strdup (description);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (block);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (block->object_owner_soft));
}
...
)
{
        ...
        block->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (block);
