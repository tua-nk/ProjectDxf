...
)
{
        ...
        oleframe->id_code = 0;
        oleframe->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        oleframe->layer = _strdup (DXF_DEFAULT_LAYER);
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("OLEFRAME");
        DxfChar *iter = NULL;
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (oleframe->linetype));
}
...
)
{
        ...
        oleframe->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (oleframe);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (oleframe->dictionary_owner_soft));
}
...
)
{
        ...
        oleframe->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (oleframe);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (oleframe->material));
}
...
)
{
        ...
        oleframe->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (oleframe);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (oleframe->dictionary_owner_hard));
}
...
)
{
        ...
        oleframe->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (oleframe);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (oleframe->plot_style_name));
}
...
)
{
        ...
        oleframe->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (oleframe);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (oleframe->color_name));
}
...
)
{
        ...
        oleframe->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (oleframe);
