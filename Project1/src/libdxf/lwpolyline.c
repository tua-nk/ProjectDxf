...
)
{
        ...
        lwpolyline->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        lwpolyline->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        lwpolyline->dictionary_owner_soft = _strdup ("");
        lwpolyline->object_owner_soft = _strdup ("");
        lwpolyline->material = _strdup ("");
        lwpolyline->dictionary_owner_hard = _strdup ("");
        lwpolyline->lineweight = 0;
        lwpolyline->plot_style_name = _strdup ("");
        lwpolyline->color_value = 0;
        lwpolyline->color_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("LWPOLYLINE");
        DxfVertex *iter = NULL;
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (lwpolyline->linetype));
}
...
)
{
        ...
        lwpolyline->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (lwpolyline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (lwpolyline->layer));
}
...
)
{
        ...
        lwpolyline->layer = _strdup (layer);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (lwpolyline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (lwpolyline->dictionary_owner_soft));
}
...
)
{
        ...
        lwpolyline->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (lwpolyline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (lwpolyline->material));
}
...
)
{
        ...
        lwpolyline->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (lwpolyline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (lwpolyline->dictionary_owner_hard));
}
...
)
{
        ...
        lwpolyline->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (lwpolyline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (lwpolyline->plot_style_name));
}
...
)
{
        ...
        lwpolyline->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (lwpolyline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (lwpolyline->color_name));
}
...
)
{
        ...
        lwpolyline->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (lwpolyline);
