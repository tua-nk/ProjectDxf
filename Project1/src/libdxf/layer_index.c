...
)
{
        ...
        layer_index->dictionary_owner_soft = _strdup ("");
        layer_index->dictionary_owner_hard = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("LAYER_INDEX");
        DxfLayerName *iter;
        int i;
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (layer_index->dictionary_owner_soft));
}
...
)
{
        ...
        layer_index->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (layer_index);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (layer_index->dictionary_owner_hard));
}
...
)
{
        ...
        layer_index->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (layer_index);
