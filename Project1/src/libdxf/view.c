...
)
{
        ...
        view->flag = 0;
        view->mode = 0;
        view->dictionary_owner_soft = _strdup ("");
        view->dictionary_owner_hard = _strdup ("");
        view->next = NULL;
#if DEBUG
        DXF_DEBUG_END
#endif
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("VIEW");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (view->dictionary_owner_soft));
}
...
)
{
        ...
        view->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (view);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (view->dictionary_owner_hard));
}
...
)
{
        ...
        view->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (view);
