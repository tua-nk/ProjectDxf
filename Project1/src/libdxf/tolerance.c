...
)
{
        ...
        tolerance->id_code = 0;
        tolerance->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        tolerance->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        tolerance->dictionary_owner_soft = _strdup ("");
        tolerance->material = _strdup ("");
        tolerance->dictionary_owner_hard = _strdup ("");
        tolerance->lineweight = 0;
        tolerance->plot_style_name = _strdup ("");
        tolerance->color_value = 0;
        tolerance->color_name = _strdup ("");
        tolerance->transparency = 0;
        tolerance->dimstyle_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("TOLERANCE");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (tolerance->linetype));
}
...
)
{
        ...
        tolerance->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (tolerance);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (tolerance->layer));
}
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (tolerance->dictionary_owner_soft));
}
...
)
{
        ...
        tolerance->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (tolerance);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (tolerance->material));
}
...
)
{
        ...
        tolerance->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (tolerance);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (tolerance->dictionary_owner_hard));
}
...
)
{
        ...
        tolerance->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (tolerance);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (tolerance->plot_style_name));
}
...
)
{
        ...
        tolerance->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (tolerance);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (tolerance->color_name));
}
...
)
{
        ...
        tolerance->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (tolerance);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (tolerance->dimstyle_name));
}
...
)
{
        ...
        tolerance->dimstyle_name = _strdup (dimstyle_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (tolerance);
