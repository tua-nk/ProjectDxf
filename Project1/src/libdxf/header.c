...
)
{
        ...
        switch (acad_version_number)
        {
                case AC1009: /* AutoCAD 12 */
                {
                        ...
                        header->AttReq = 1;
                        header->Handling = 1;
                        header->HandSeed = _strdup ("233");

                }
                case AC1012: /* AutoCAD 13 */
                {
                        header->DWGCodePage = _strdup ("ANSI_1252");
                        header->DragMode = 2;
                        header->OSMode = 125;
                        ...
                        header->DimALTU = 2;
                        header->DimALTTD = 2;
                        header->DimTXSTY = _strdup ("STANDARD");
                        header->DimAUNIT = 0;
                        header->BlipMode = 0;
                        ...
                        header->PickStyle = 1;
                        header->CMLStyle = _strdup ("STANDARD");
                        header->CMLJust = 0;
                        header->CMLScale = 1.0;
                        header->SaveImages = 1;
                }
                ...
                case AC1015: /* AutoCAD 2000 */
                {
                        ...
                        header->HandSeed = _strdup ("274");
                        header->UCSBase = _strdup ("");
                        header->UCSOrthoRef = _strdup ("");
                        ...
                        header->PUCSBase = _strdup ("");
                        header->PUCSOrthoRef = _strdup ("");
                        ...
                        header->LWDisplay = 0;
                        header->InsUnits = 0;
                        header->HyperLinkBase = _strdup ("");
                        header->StyleSheet = _strdup ("");
                        header->XEdit = 1;
                        header->CEPSNType = 0;
                        header->PStyleMode = 1;
                        header->FingerPrintGUID = _strdup ("");
                        header->VersionGUID = _strdup ("");
                        header->ExtNames = 0;
                ...
                case AC1018: /* AutoCAD 2004 */
                {
                        ...
                        header->DimASSOC = 1;
                        header->ProjectName = _strdup ("");
                }
        }
        header->AcadVer = _strdup (dxf_header_acad_version_to_string (acad_version_number));
        ...
        header->TextSize = 2.5;
        header->TraceWid = 1.0;
        header->TextStyle = _strdup ("STANDARD");
        header->CELType = _strdup ("BYLAYER");
        header->CLayer = _strdup ("0");
        header->CEColor = 256;
        header->DimSCALE = 1.0;
        header->DimASZ = 2.5;
        header->DimEXO = 0.625;
        ...
        header->DimTAD = 1;
        header->DimZIN = 8;
        header->DimBLK = _strdup ("");
        header->DimASO = 1;
        header->DimSHO = 1;
        header->DimPOST = _strdup ("");
        header->DimAPOST = _strdup ("");
        header->DimALT = 0;
        header->DimALTD = 4;
        ...
        header->DimSOXD = 0;
        header->DimSAH = 0;
        header->DimBLK1 = _strdup ("");
        header->DimBLK2 = _strdup ("");
        header->DimCLRD = 0;
        header->DimCLRE = 0;
        header->DimCLRT = 0;
        header->DimTFAC = 1.0;
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("HEADER");
