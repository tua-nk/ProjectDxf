...
)
{
        ...
        line->id_code = 0;
        line->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        line->layer = _strdup (DXF_DEFAULT_LAYER);
        line->elevation = 0.0;
        line->thickness = 0.0;
        ...
        line->shadow_mode = 0;
        line->dictionary_owner_soft = _strdup ("");
        line->object_owner_soft = _strdup ("");
        line->material = _strdup ("");
        line->dictionary_owner_hard = _strdup ("");
        line->lineweight = 0;
        line->plot_style_name = _strdup ("");
        line->color_value = 0;
        line->color_name = _strdup ("");
        line->transparency = 0;
        line->extr_x0 = 0.0;
        line->extr_y0 = 0.0;
        line->extr_z0 = 0.0;
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("3DLINE");
...
)
{
        ...
        line->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (line);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (line->dictionary_owner_soft));
}
...
)
{
        ...
        line->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (line);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (line->object_owner_soft));
}
...
)
{
        ...
        line->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (line);
...
)
{
        ...
        line->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (line);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (line->dictionary_owner_hard));
}
...
)
{
        ...
        line->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (line);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (line->plot_style_name));
}
...
)
{
        ...
        line->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (line);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (line->color_name));
}
...
)
{
        ...
        line->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (line);
...
)
{
        ...
        switch (inheritance)
        {
                ...
                case 1:
                        if (line->linetype != NULL)
                        {
                                point->linetype = _strdup (line->linetype);
                        }
                        if (line->layer != NULL)
                        {
                                point->layer = _strdup (line->layer);
                        }
                        ...
                        if (line->dictionary_owner_soft != NULL)
                        {
                                point->dictionary_owner_soft = _strdup (line->dictionary_owner_soft);
                        }
                        if (line->object_owner_soft != NULL)
                        {
                                point->object_owner_soft = _strdup (line->object_owner_soft);
                        }
                        if (line->material != NULL)
                        {
                                point->material = _strdup (line->material);
                        }
                        if (line->dictionary_owner_hard != NULL)
                        {
                                point->dictionary_owner_hard = _strdup (line->dictionary_owner_hard);
                        }
                        point->lineweight = line->lineweight;
                        if (line->plot_style_name != NULL)
                        {
                                point->plot_style_name = _strdup (line->plot_style_name);
                        }
                        point->color_value = line->color_value;
                        if (line->color_name != NULL)
                        {
                                point->color_name = _strdup (line->color_name);
                        }
...
)
{
        ...
        switch (inheritance)
        {
                ...
                case 1:
                        ...
                        {
                                line->dictionary_owner_soft = _strdup (p0->dictionary_owner_soft);
                        }
                        ...
                        {
                                line->object_owner_soft = _strdup (p0->object_owner_soft);
                        }
                        if (p0->material == NULL)
                        {
                                fprintf (stderr,
                        ...
                        {
                                line->material = _strdup (p0->material);
                        }
                        ...
                        {
                                line->dictionary_owner_hard = _strdup (p0->dictionary_owner_hard);
                        }
                        ...
                        {
                                line->plot_style_name = _strdup (p0->plot_style_name);
                        }
                        ...
                        {
                                line->color_name = _strdup (p0->color_name);
                        }
                ...
                case 2:
                        ...
                        {
                                line->dictionary_owner_soft = _strdup (p1->dictionary_owner_soft);
                        }
                        ...
                        {
                                line->object_owner_soft = _strdup (p1->object_owner_soft);
                        }
                        if (p1->material == NULL)
                        {
                                fprintf (stderr,
                        ...
                        {
                                line->material = _strdup (p1->material);
                        }
                        ...
                        {
                                line->dictionary_owner_hard = _strdup (p1->dictionary_owner_hard);
                        }
                        ...
                        {
                                line->plot_style_name = _strdup (p1->plot_style_name);
                        }
                        ...
                        {
                                line->color_name = _strdup (p1->color_name);
                        }
