...
)
{
        ...
        rtext->id_code = 0;
        rtext->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        rtext->layer = _strdup (DXF_DEFAULT_LAYER);
        rtext->elevation = 0.0;
        rtext->thickness = 0.0;
        ...
        rtext->dictionary_owner_soft = _strdup ("");
        rtext->material = _strdup ("");
        rtext->dictionary_owner_hard = _strdup ("");
        rtext->lineweight = 0;
        rtext->plot_style_name = _strdup ("");
        rtext->color_value = 0;
        rtext->color_name = _strdup ("");
        rtext->transparency = 0;
        rtext->text_value = _strdup ("");
        rtext->text_style = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("RTEXT");
...
)
{
        ...
        if (strcmp (rtext->text_style, "") == 0)
        {
                fprintf (stderr,
                  ...
                  __FUNCTION__, dxf_entity_name, rtext->id_code);
                rtext->text_style = _strdup (DXF_DEFAULT_TEXTSTYLE);
        }
        if (strcmp (rtext->layer, "") == 0)
        {
                fprintf (stderr,
...
)
{
        ...
        rtext->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (rtext);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (rtext->dictionary_owner_soft));
}
...
)
{
        ...
        rtext->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (rtext);
...
)
{
        ...
        rtext->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (rtext);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (rtext->dictionary_owner_hard));
}
...
)
{
        ...
        rtext->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (rtext);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (rtext->plot_style_name));
}
...
)
{
        ...
        rtext->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (rtext);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (rtext->color_name));
}
...
)
{
        ...
        rtext->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (rtext);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (rtext->text_value));
}
...
)
{
        ...
        rtext->text_value = _strdup (text_value);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (rtext);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (rtext->text_style));
}
...
)
{
        ...
        rtext->text_style = _strdup (text_style);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (rtext);
