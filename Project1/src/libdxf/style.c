...
)
{
        ...
        style->id_code = 0;
        style->style_name = _strdup ("");
        style->primary_font_filename = _strdup ("");
        style->big_font_filename = _strdup ("");
        style->height = 0.0;
        style->width = 0.0;
        ...
        style->dictionary_owner_soft = _strdup ("");
        style->dictionary_owner_hard = _strdup ("");
        style->ttf_flags = 0;
        style->next = NULL;
#if DEBUG
        DXF_DEBUG_END
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("STYLE");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (style->style_name));
}
...
)
{
        ...
        style->style_name = _strdup (style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (style);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (style->primary_font_filename));
}
...
)
{
        ...
        style->primary_font_filename = _strdup (primary_font_filename);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (style);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (style->big_font_filename));
}
...
)
{
        ...
        style->big_font_filename = _strdup (big_font_filename);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (style);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (style->dictionary_owner_soft));
}
...
)
{
        ...
        style->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (style);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (style->dictionary_owner_hard));
}
...
)
{
        ...
        style->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (style);
