...
)
{
        ...
        object_ptr->dictionary_owner_soft = _strdup ("");
        object_ptr->dictionary_owner_hard = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("OBJECT_PTR");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (object_ptr->dictionary_owner_soft));
}
...
)
{
        ...
        object_ptr->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (object_ptr);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (object_ptr->dictionary_owner_hard));
}
...
)
{
        ...
        object_ptr->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (object_ptr);
