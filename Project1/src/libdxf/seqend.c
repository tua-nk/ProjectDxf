...
)
{
        ...
        seqend->id_code = 0;
        seqend->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        seqend->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        seqend->dictionary_owner_soft = _strdup ("");
        seqend->material = _strdup ("");
        seqend->dictionary_owner_hard = _strdup ("");
        seqend->lineweight = 0;
        seqend->plot_style_name = _strdup ("");
        seqend->color_value = 0;
        seqend->color_name = _strdup ("");
        seqend->transparency = 0;
        seqend->app_name = _strdup ("");
#if DEBUG
        DXF_DEBUG_END
#endif
        return (seqend);
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("SEQEND");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (seqend->linetype));
}
...
)
{
        ...
        seqend->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (seqend);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (seqend->dictionary_owner_soft));
}
...
)
{
        ...
        seqend->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (seqend);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (seqend->material));
}
...
)
{
        ...
        seqend->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (seqend);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (seqend->dictionary_owner_hard));
}
...
)
{
        ...
        seqend->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (seqend);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (seqend->plot_style_name));
}
...
)
{
        ...
        seqend->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (seqend);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (seqend->color_name));
}
...
)
{
        ...
        seqend->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (seqend);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (seqend->app_name));
}
...
)
{
        ...
        seqend->app_name = _strdup (app_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (seqend);
