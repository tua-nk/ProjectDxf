...
)
{
        ...
        hatch->id_code = 0;
        hatch->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        hatch->layer = _strdup (DXF_DEFAULT_LAYER);
        hatch->elevation = 0.0;
        hatch->thickness = 0.0;
        ...
        hatch->shadow_mode = 0;
        hatch->dictionary_owner_soft = _strdup ("");
        hatch->object_owner_soft = _strdup ("");
        hatch->material = _strdup ("");
        hatch->dictionary_owner_hard = _strdup ("");
        hatch->lineweight = 0;
        hatch->plot_style_name = _strdup ("");
        hatch->color_value = 0;
        hatch->color_name = _strdup ("");
        hatch->transparency = 0;
        hatch->pattern_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("HATCH");
...
)
{
        ...
        hatch->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (hatch);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (hatch->dictionary_owner_soft));
}
...
)
{
        ...
        hatch->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (hatch);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (hatch->object_owner_soft));
}
...
)
{
        ...
        hatch->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (hatch);
...
)
{
        ...
        hatch->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (hatch);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (hatch->dictionary_owner_hard));
}
...
)
{
        ...
        hatch->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (hatch);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (hatch->plot_style_name));
}
...
)
{
        ...
        hatch->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (hatch);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (hatch->color_name));
}
...
)
{
        ...
        hatch->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (hatch);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (hatch->pattern_name));
}
...
)
{
        ...
        hatch->pattern_name = _strdup (pattern_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (hatch);
