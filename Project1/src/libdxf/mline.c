...
)
{
        ...
        dxf_mline_set_linetype (mline, _strdup (DXF_DEFAULT_LINETYPE));
        dxf_mline_set_layer (mline, _strdup (DXF_DEFAULT_LAYER));
        ...
        dxf_mline_set_dictionary_owner_soft (mline, _strdup (""));
        dxf_mline_set_material (mline, _strdup (""));
        dxf_mline_set_dictionary_owner_hard (mline, _strdup (""));
        dxf_mline_set_lineweight (mline, 0);
        dxf_mline_set_plot_style_name (mline, _strdup (""));
        dxf_mline_set_color_value (mline, 0);
        dxf_mline_set_color_name (mline, _strdup (""));
        dxf_mline_set_transparency (mline, 0);
        dxf_mline_set_style_name (mline, _strdup (""));
        ...
        dxf_mline_set_mlinestyle_dictionary (mline, _strdup (""));
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("MLINE");
        int i;
        DxfPoint *iter;
...
)
{
        ...
        mline->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mline->dictionary_owner_soft));
}
...
)
{
        ...
        mline->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mline);
...
)
{
        ...
        mline->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mline->dictionary_owner_hard));
}
...
)
{
        ...
        mline->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mline->plot_style_name));
}
...
)
{
        ...
        mline->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mline->color_name));
}
...
)
{
        ...
        mline->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mline->style_name));
}
...
)
{
        ...
        mline->style_name = _strdup (style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mline);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mline->mlinestyle_dictionary));
}
...
)
{
        ...
        mline->mlinestyle_dictionary = _strdup (mlinestyle_dictionary);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mline);
