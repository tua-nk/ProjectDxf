...
)
{
        ...
        mleaderstyle->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        mleaderstyle->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        mleaderstyle->dictionary_owner_soft = _strdup ("");
        mleaderstyle->object_owner_soft = _strdup ("");
        mleaderstyle->material = _strdup ("");
        mleaderstyle->dictionary_owner_hard = _strdup ("");
        mleaderstyle->lineweight = 0;
        mleaderstyle->plot_style_name = _strdup ("");
        mleaderstyle->color_value = 0;
        mleaderstyle->color_name = _strdup ("");
        mleaderstyle->transparency = 0;
        mleaderstyle->mleaderstyle_description = _strdup ("");
        ...
        mleaderstyle->default_mtext_contents = _strdup ("");
        mleaderstyle->leader_linetype_id = _strdup ("");
        mleaderstyle->arrow_head_id = _strdup ("");
        mleaderstyle->mtext_style_id = _strdup ("");
        mleaderstyle->block_content_id = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("MLEADERSTYLE");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleaderstyle->linetype));
}
...
)
{
        ...
        mleaderstyle->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleaderstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleaderstyle->layer));
}
...
)
{
        ...
        mleaderstyle->layer = _strdup (layer);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleaderstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleaderstyle->dictionary_owner_soft));
}
...
)
{
        ...
        mleaderstyle->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleaderstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleaderstyle->object_owner_soft));
}
...
)
{
        ...
        mleaderstyle->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleaderstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleaderstyle->material));
}
...
)
{
        ...
        mleaderstyle->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleaderstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleaderstyle->dictionary_owner_hard));
}
...
)
{
        ...
        mleaderstyle->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleaderstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleaderstyle->plot_style_name));
}
...
)
{
        ...
        mleaderstyle->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleaderstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleaderstyle->color_name));
}
...
)
{
        ...
        mleaderstyle->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleaderstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleaderstyle->mleaderstyle_description));
}
...
)
{
        ...
        mleaderstyle->mleaderstyle_description = _strdup (mleaderstyle_description);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleaderstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleaderstyle->default_mtext_contents));
}
...
)
{
        ...
        mleaderstyle->default_mtext_contents = _strdup (default_mtext_contents);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleaderstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleaderstyle->leader_linetype_id));
}
...
)
{
        ...
        mleaderstyle->leader_linetype_id = _strdup (leader_linetype_id);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleaderstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleaderstyle->arrow_head_id));
}
...
)
{
        ...
        mleaderstyle->arrow_head_id = _strdup (arrow_head_id);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleaderstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleaderstyle->mtext_style_id));
}
...
)
{
        ...
        mleaderstyle->mtext_style_id = _strdup (mtext_style_id);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleaderstyle);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mleaderstyle->block_content_id));
}
...
)
{
        ...
        mleaderstyle->block_content_id = _strdup (block_content_id);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mleaderstyle);
