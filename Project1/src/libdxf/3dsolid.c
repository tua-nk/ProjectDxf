...
)
{
        ...
        solid->id_code = 0;
        solid->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        solid->layer = _strdup (DXF_DEFAULT_LAYER);
        solid->elevation = 0.0;
        solid->thickness = 0.0;
        ...
        solid->shadow_mode = 0;
        solid->dictionary_owner_soft = _strdup ("");
        solid->object_owner_soft = _strdup ("");
        solid->material = _strdup ("");
        solid->dictionary_owner_hard = _strdup ("");
        solid->lineweight = 0;
        solid->plot_style_name = _strdup ("");
        solid->color_value = 0;
        solid->color_name = _strdup ("");
        solid->transparency = 0;
        solid->modeler_format_version_number = 1;
        solid->history = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("3DSOLID");
...
)
{
        ...
        solid->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (solid);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (solid->dictionary_owner_soft));
}
...
)
{
        ...
        solid->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (solid);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (solid->object_owner_soft));
}
...
)
{
        ...
        solid->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (solid);
...
)
{
        ...
        solid->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (solid);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (solid->dictionary_owner_hard));
}
...
)
{
        ...
        solid->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (solid);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (solid->plot_style_name));
}
...
)
{
        ...
        solid->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (solid);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (solid->color_name));
}
...
)
{
        ...
        solid->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (solid);
