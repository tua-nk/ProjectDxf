...
)
{
        ...
        imagedef_reactor->dictionary_owner_soft = _strdup ("");
        imagedef_reactor->dictionary_owner_hard = _strdup ("");
        imagedef_reactor->class_version = 2;
        imagedef_reactor->associated_image_object = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("IMAGEDEF_REACTOR");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (imagedef_reactor->dictionary_owner_soft));
}
...
)
{
        ...
        imagedef_reactor->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (imagedef_reactor);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (imagedef_reactor->dictionary_owner_hard));
}
...
)
{
        ...
        imagedef_reactor->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (imagedef_reactor);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (imagedef_reactor->associated_image_object));
}
...
)
{
        ...
        imagedef_reactor->associated_image_object = _strdup (associated_image_object);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (imagedef_reactor);
