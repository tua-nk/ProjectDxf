...
)
{
        ...
        sortentstable->dictionary_owner_soft = _strdup ("");
        sortentstable->dictionary_owner_hard = _strdup ("");
        sortentstable->block_owner = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("SORTENTSTABLE");
        DxfInt *iter_5 = NULL;
        DxfChar *iter_331 = NULL;
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (sortentstable->dictionary_owner_soft));
}
...
)
{
        ...
        sortentstable->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (sortentstable);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (sortentstable->dictionary_owner_hard));
}
...
)
{
        ...
        sortentstable->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (sortentstable);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (sortentstable->block_owner));
}
...
)
{
        ...
        sortentstable->block_owner = _strdup (block_owner);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (sortentstable);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (entity_owner->value));
}
