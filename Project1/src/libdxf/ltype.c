...
)
{
        ...
        ltype->id_code = 0;
        ltype->linetype_name = _strdup ("");
        ltype->description = _strdup ("");
        ltype->total_pattern_length = 0.0;
        ltype->number_of_linetype_elements = 0;
        ltype->flag = 0;
        ltype->alignment = 65;
        ltype->dictionary_owner_soft = _strdup ("");
        ltype->dictionary_owner_hard = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("LTYPE");
        int i;
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ltype->linetype_name));
}
...
)
{
        ...
        ltype->linetype_name = _strdup (linetype_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ltype);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ltype->description));
}
...
)
{
        ...
        ltype->description = _strdup (description);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ltype);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ltype->dictionary_owner_soft));
}
...
)
{
        ...
        ltype->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ltype);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ltype->dictionary_owner_hard));
}
...
)
{
        ...
        ltype->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ltype);
