...
)
{
        ...
        ole2frame->id_code = 0;
        ole2frame->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        ole2frame->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        ole2frame->dictionary_owner_soft = _strdup ("");
        ole2frame->dictionary_owner_hard = _strdup ("");
        ole2frame->end_of_data = _strdup ("OLE");
        ole2frame->length_of_binary_data = _strdup ("");
        ...
        ole2frame->binary_data->value = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("OLE2FRAME");
        DxfChar *iter = NULL;
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ole2frame->linetype));
}
...
)
{
        ...
        ole2frame->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ole2frame);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ole2frame->layer));
}
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ole2frame->dictionary_owner_soft));
}
...
)
{
        ...
        ole2frame->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ole2frame);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ole2frame->material));
}
...
)
{
        ...
        ole2frame->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ole2frame);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ole2frame->dictionary_owner_hard));
}
...
)
{
        ...
        ole2frame->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ole2frame);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ole2frame->plot_style_name));
}
...
)
{
        ...
        ole2frame->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ole2frame);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ole2frame->color_name));
}
...
)
{
        ...
        ole2frame->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ole2frame);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ole2frame->end_of_data));
}
...
)
{
        ...
        ole2frame->end_of_data = _strdup (end_of_data);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ole2frame);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (ole2frame->length_of_binary_data));
}
...
)
{
        ...
        ole2frame->length_of_binary_data = _strdup (length_of_binary_data);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (ole2frame);
