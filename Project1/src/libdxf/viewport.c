...
)
{
        ...
        viewport->id_code = 0;
        viewport->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        viewport->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        viewport->app_name = _strdup ("ACAD"); /* Always "ACAD". */
        viewport->viewport_data = _strdup ("MVIEW"); /* Always "MVIEW". */
        viewport->window_descriptor_begin = _strdup ("{"); /* Always "{". */
        ...
        viewport->frozen_layer_list_begin = _strdup ("{"); /* Always "{". */
        viewport->frozen_layers = dxf_char_new ();
        viewport->frozen_layers = dxf_char_init (viewport->frozen_layers);
        viewport->frozen_layers->value = _strdup ("");
        viewport->frozen_layers->length = 0;
        viewport->frozen_layers->next = NULL;
        viewport->frozen_layer_list_end = _strdup ("}"); /* Always "}". */
        viewport->window_descriptor_end = _strdup ("}"); /* Always "}". */
        viewport->dictionary_owner_soft = _strdup ("");
        viewport->dictionary_owner_hard = _strdup ("");
        viewport->next = NULL;
#if DEBUG
        DXF_DEBUG_END
#endif
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("VIEWPORT");
        DxfChar *iter = NULL;
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (viewport->linetype));
}
...
)
{
        ...
        viewport->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (viewport);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (viewport->dictionary_owner_soft));
}
...
)
{
        ...
        viewport->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (viewport);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (viewport->material));
}
...
)
{
        ...
        viewport->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (viewport);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (viewport->dictionary_owner_hard));
}
...
)
{
        ...
        viewport->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (viewport);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (viewport->plot_style_name));
}
...
)
{
        ...
        viewport->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (viewport);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (viewport->color_name));
}
...
)
{
        ...
        viewport->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (viewport);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (viewport->app_name));
}
...
)
{
        ...
        viewport->app_name = _strdup (app_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (viewport);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (viewport->viewport_data));
}
...
)
{
        ...
        viewport->viewport_data = _strdup (viewport_data);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (viewport);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (viewport->window_descriptor_begin));
}
...
)
{
        ...
        viewport->window_descriptor_begin = _strdup (window_descriptor_begin);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (viewport);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (viewport->frozen_layer_list_begin));
}
...
)
{
        ...
        viewport->frozen_layer_list_begin = _strdup (frozen_layer_list_begin);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (viewport);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (viewport->frozen_layer_list_end));
}
...
)
{
        ...
        viewport->frozen_layer_list_end = _strdup (frozen_layer_list_end);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (viewport);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (viewport->window_descriptor_end));
}
...
)
{
        ...
        viewport->window_descriptor_end = _strdup (window_descriptor_end);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (viewport);
