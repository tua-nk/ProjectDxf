...
)
{
        ...
        imagedef->id_code = 0;
        imagedef->dictionary_owner_soft = _strdup ("");
        imagedef->dictionary_owner_hard = _strdup ("");
        imagedef->file_name = _strdup ("");
        imagedef->class_version = 0;
        imagedef->image_is_loaded_flag = 0;
        imagedef->resolution_units = 0;
        imagedef->acad_image_dict_soft = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("IMAGEDEF");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (imagedef->dictionary_owner_soft));
}
...
)
{
        ...
        imagedef->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (imagedef);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (imagedef->dictionary_owner_hard));
}
...
)
{
        ...
        imagedef->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (imagedef);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (imagedef->file_name));
}
...
)
{
        ...
        imagedef->file_name = _strdup (file_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (imagedef);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (imagedef->acad_image_dict_soft));
}
...
)
{
        ...
        imagedef->acad_image_dict_soft = _strdup (acad_image_dict_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (imagedef);
