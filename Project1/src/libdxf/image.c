...
)
{
        ...
        image->id_code = 0;
        image->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        image->layer = _strdup (DXF_DEFAULT_LAYER);
        image->elevation = 0.0;
        image->thickness = 0.0;
        ...
        image->shadow_mode = 0;
        image->dictionary_owner_soft = _strdup ("");
        image->material = _strdup ("");
        image->dictionary_owner_hard = _strdup ("");
        image->lineweight = 0;
        image->plot_style_name = _strdup ("");
        image->color_value = 0;
        image->color_name = _strdup ("");
        ...
        image->contrast = 50;
        image->fade = 50;
        image->imagedef_object = _strdup ("");
        image->imagedef_reactor_object = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("IMAGE");
        DxfPoint *iter = NULL;
...
)
{
        ...
        image->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (image);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (image->dictionary_owner_soft));
}
...
)
{
        ...
        image->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (image);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (image->object_owner_soft));
}
...
)
{
        ...
        image->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (image);
...
)
{
        ...
        image->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (image);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (image->dictionary_owner_hard));
}
...
)
{
        ...
        image->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (image);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (image->plot_style_name));
}
...
)
{
        ...
        image->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (image);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (image->color_name));
}
...
)
{
        ...
        image->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (image);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (image->imagedef_object));
}
...
)
{
        ...
        image->imagedef_object = _strdup (imagedef_object);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (image);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (image->imagedef_reactor_object));
}
...
)
{
        ...
        image->imagedef_reactor_object = _strdup (imagedef_reactor_object);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (image);
