...
)
{
        ...
        mtext->id_code = 0;
        mtext->text_value = _strdup ("");
        for (i = 1; i < DXF_MAX_PARAM; i++)
        {
                mtext->text_additional_value[i] = _strdup ("");
        }
        mtext->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        mtext->text_style = _strdup ("");
        mtext->layer = _strdup (DXF_DEFAULT_LAYER);
        mtext->p0->x0 = 0.0;
        mtext->p0->y0 = 0.0;
        mtext->p0->z0 = 0.0;
        mtext->p1->x0 = 0.0;
        ...
        mtext->background_color_name = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("MTEXT");
        int i;
...
)
{
        ...
        mtext->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mtext);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mtext->dictionary_owner_soft));
}
...
)
{
        ...
        mtext->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mtext);
...
)
{
        ...
        mtext->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mtext);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mtext->dictionary_owner_hard));
}
...
)
{
        ...
        mtext->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mtext);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mtext->plot_style_name));
}
...
)
{
        ...
        mtext->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mtext);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mtext->color_name));
}
...
)
{
        ...
        mtext->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mtext);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mtext->text_value));
}
...
)
{
        ...
        mtext->text_value = _strdup (text_value);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mtext);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mtext->text_style));
}
...
)
{
        ...
        mtext->text_style = _strdup (text_style);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mtext);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (mtext->background_color_name));
}
...
)
{
        ...
        mtext->background_color_name = _strdup (background_color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (mtext);
