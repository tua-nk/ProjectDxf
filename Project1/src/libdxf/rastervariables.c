...
)
{
        ...
        rastervariables->dictionary_owner_soft = _strdup ("");
        rastervariables->dictionary_owner_hard = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("RASTERVARIABLES");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (rastervariables->dictionary_owner_soft));
}
...
)
{
        ...
        rastervariables->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (rastervariables);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (rastervariables->dictionary_owner_hard));
}
...
)
{
        ...
        rastervariables->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (rastervariables);
