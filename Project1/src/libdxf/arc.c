...
)
{
        ...
        arc->id_code = 0;
        arc->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        arc->layer = _strdup (DXF_DEFAULT_LAYER);
        arc->elevation = 0.0;
        arc->thickness = 0.0;
        ...
        arc->shadow_mode = 0;
        arc->dictionary_owner_soft = _strdup ("");
        arc->object_owner_soft = _strdup ("");
        arc->material = _strdup ("");
        arc->dictionary_owner_hard = _strdup ("");
        arc->lineweight = 0;
        arc->plot_style_name = _strdup ("");
        arc->color_value = 0;
        arc->color_name = _strdup ("");
        arc->transparency = 0;
        arc->p0->x0 = 0.0;
        arc->p0->y0 = 0.0;
        arc->p0->z0 = 0.0;
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("ARC");
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (arc->dictionary_owner_soft));
}
...
)
{
        ...
        arc->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (arc);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (arc->object_owner_soft));
}
...
)
{
        ...
        arc->object_owner_soft = _strdup (object_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (arc);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (arc->dictionary_owner_hard));
}
...
)
{
        ...
        arc->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (arc);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (arc->plot_style_name));
}
...
)
{
        ...
        arc->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (arc);
...
)
{
        ...
        arc->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (arc);
