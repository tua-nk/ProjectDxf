...
)
{
        ...
        shape->id_code = 0;
        shape->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        shape->layer = _strdup (DXF_DEFAULT_LAYER);
        shape->elevation = 0.0;
        shape->thickness = 0.0;
        ...
        shape->dictionary_owner_soft = _strdup ("");
        shape->material = _strdup ("");
        shape->dictionary_owner_hard = _strdup ("");
        shape->lineweight = 0;
        shape->plot_style_name = _strdup ("");
        shape->color_value = 0;
        shape->color_name = _strdup ("");
        shape->transparency = 0;
        shape->shape_name = _strdup ("");
        shape->p0->x0 = 0.0;
        shape->p0->y0 = 0.0;
        shape->p0->z0 = 0.0;
        shape->size = 0.0;
...
)
{
        ...
        char *dxf_entity_name = _strdup ("SHAPE");
...
)
{
        ...
        shape->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (shape);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (shape->dictionary_owner_soft));
}
...
)
{
        ...
        shape->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (shape);
...
)
{
        ...
        shape->material = _strdup (material);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (shape);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (shape->dictionary_owner_hard));
}
...
)
{
        ...
        shape->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (shape);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (shape->plot_style_name));
}
...
)
{
        ...
        shape->plot_style_name = _strdup (plot_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (shape);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (shape->color_name));
}
...
)
{
        ...
        shape->color_name = _strdup (color_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (shape);
