...
)
{
        ...
        leader->id_code = 0;
        leader->linetype = _strdup (DXF_DEFAULT_LINETYPE);
        leader->layer = _strdup (DXF_DEFAULT_LAYER);
        ...
        leader->dictionary_owner_soft = _strdup ("");
        leader->object_owner_soft = _strdup ("");
        leader->material = _strdup ("");
        leader->dictionary_owner_hard = _strdup ("");
        leader->lineweight = 0;
        leader->plot_style_name = _strdup ("");
        leader->color_value = 0;
        leader->color_name = _strdup ("");
        leader->transparency = 0;
        leader->dimension_style_name = _strdup ("");
        ...
        leader->extr_y0 = 0.0;
        leader->extr_z0 = 0.0;
        leader->annotation_reference_hard = _strdup ("");
...
)
{
        ...
        DXF_DEBUG_BEGIN
#endif
        char *dxf_entity_name = _strdup ("LEADER");
        int i;
        DxfPoint *iter;
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (leader->linetype));
}
...
)
{
        ...
        leader->linetype = _strdup (linetype);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (leader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (leader->dictionary_owner_soft));
}
...
)
{
        ...
        leader->dictionary_owner_soft = _strdup (dictionary_owner_soft);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (leader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (leader->dictionary_owner_hard));
}
...
)
{
        ...
        leader->dictionary_owner_hard = _strdup (dictionary_owner_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (leader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (leader->dimension_style_name));
}
...
)
{
        ...
        leader->layer = _strdup (dimension_style_name);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (leader);
...
)
{
        ...
        DXF_DEBUG_END
#endif
        return (_strdup (leader->annotation_reference_hard));
}
...
)
{
        ...
        leader->annotation_reference_hard = _strdup (annotation_reference_hard);
#if DEBUG
        DXF_DEBUG_END
#endif
        return (leader);
