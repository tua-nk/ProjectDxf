 ...
 */
int dxflib::entities::solid3d_buf::parse(const std::string& cl, const std::string& nl)
{
...
void dxflib::entities::solid3d_buf::free()
{
 ...
 */
dxflib::entities::solid3d::solid3d(solid3d_buf& lb) :
	entity(lb),
